...
//     ctx.fillText(text,(x-transform.x)*transform.xScale*SCALE,(y-transform.y)*transform.yScale*SCALE);
//
// }
//
...
//                 for (let i = 0; i < 24; i++) {
//                     DrawText(canvas, i + ":00", ((i + 24) * 3600), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":20", ((i + 24) * 3600 + 1200), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":40", ((i + 24) * 3600 + 2400), -fontSize, transform, SCALE);
//                 }
//             } else {
//                 for (let i = 0; i < 24; i++) {
//                     DrawText(canvas, i.toString(), i * 3600, -50, transform, SCALE);
...
//                 for (let i = 0; i < 24; i++) {
//                     DrawText(canvas, i + ":15", ((i + 24) * 3600 + 900), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":45", ((i + 24) * 3600 + 2700), -fontSize, transform, SCALE);
//                 }
//             }
//         case 1:
//             if (fontSize * 5 < 30 * 60 * transform.xScale) {
//                 for (let i = 0; i < 24; i++) {
//                     DrawText(canvas, i + ":00", ((i + 24) * 3600 + 0), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":30", ((i + 24) * 3600 + 1800), -fontSize, transform, SCALE);
//                 }
//             } else {
//                 for (let i = 0; i < 24; i++) {
//                     DrawText(canvas, i.toString(), i * 3600, -50, transform, SCALE);
...
//                 for (let i = 0; i < 24; i++) {
//                     DrawText(canvas, i + ":05", ((i + 24) * 3600 + 300), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":15", ((i + 24) * 3600 + 900), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":25", ((i + 24) * 3600 + 1500), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":35", ((i + 24) * 3600 + 2100), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":45", ((i + 24) * 3600 + 2700), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":55", ((i + 24) * 3600 + 3300), -fontSize, transform, SCALE);
//                 }
//             }
//         case 6:
//         case 5:
...
//                 for (let i = 0; i < 24; i++) {
//                     DrawText(canvas, i + ":10", ((i + 24) * 3600 + 600), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":20", ((i + 24) * 3600 + 1200), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":40", ((i + 24) * 3600 + 2400), -fontSize, transform, SCALE);
//                     DrawText(canvas, i + ":50", ((i + 24) * 3600 + 3000), -fontSize, transform, SCALE);
//                 }
//             }
//             if (fontSize * 5 < 30 * 60 * transform.xScale) {
//                 for (let i = 0; i < 24; i++) {
...
//     //DrawTimeHeader(ctx,verticalAxis,transform,diaRect,SCALE);
//
//     switch (verticalAxis){
//         case 1:
//             for (let i = 0; i < 24; i++) {
...
//                 ctx.strokeStyle = "#AAA";
//                 ctx.lineWidth = SCALE;
//                 ctx.moveTo((i*3600+600-transform.x)*transform.xScale*SCALE, (diaRect.yStart-transform.y)*transform.yScale*SCALE);
//                 ctx.lineTo((i*3600+600-transform.x)*transform.xScale*SCALE, (diaRect.yEnd-transform.y)*transform.yScale*SCALE);
//                 ctx.stroke();
//                 ctx.beginPath();
//                 ctx.strokeStyle = "#AAA";
//                 ctx.lineWidth = SCALE;
//                 ctx.moveTo((i*3600+1200-transform.x)*transform.xScale*SCALE, (diaRect.yStart-transform.y)*transform.yScale*SCALE);
//                 ctx.lineTo((i*3600+1200-transform.x)*transform.xScale*SCALE, (diaRect.yEnd-transform.y)*transform.yScale*SCALE);
//                 ctx.stroke();
//                 ctx.beginPath();
//                 ctx.strokeStyle = "#AAA";
//                 ctx.lineWidth = SCALE;
//                 ctx.moveTo((i*3600+1800-transform.x)*transform.xScale*SCALE, (diaRect.yStart-transform.y)*transform.yScale*SCALE);
//                 ctx.lineTo((i*3600+1800-transform.x)*transform.xScale*SCALE, (diaRect.yEnd-transform.y)*transform.yScale*SCALE);
//                 ctx.stroke();
//                 ctx.beginPath();
//                 ctx.strokeStyle = "#AAA";
//                 ctx.lineWidth = SCALE;
//                 ctx.moveTo((i*3600+2400-transform.x)*transform.xScale*SCALE, (diaRect.yStart-transform.y)*transform.yScale*SCALE);
//                 ctx.lineTo((i*3600+2400-transform.x)*transform.xScale*SCALE, (diaRect.yEnd-transform.y)*transform.yScale*SCALE);
//                 ctx.stroke();
//                 ctx.beginPath();
//                 ctx.strokeStyle = "#AAA";
//                 ctx.lineWidth = SCALE;
//                 ctx.moveTo((i*3600+3000-transform.x)*transform.xScale*SCALE, (diaRect.yStart-transform.y)*transform.yScale*SCALE);
//                 ctx.lineTo((i*3600+3000-transform.x)*transform.xScale*SCALE, (diaRect.yEnd-transform.y)*transform.yScale*SCALE);
//                 ctx.stroke();
//             }
...
//                 ctx.strokeStyle = "#AAA";
//                 ctx.lineWidth = SCALE;
//                 ctx.moveTo((i * 300 - transform.x) * transform.xScale * SCALE, (diaRect.yStart - transform.y) * transform.yScale * SCALE);
//                 ctx.lineTo((i * 300 - transform.x) * transform.xScale * SCALE, (diaRect.yEnd - transform.y) * transform.yScale * SCALE);
//                 ctx.stroke();
//             }
//             break;
//         case 6:
